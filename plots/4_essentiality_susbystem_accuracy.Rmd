...
```{r}
path_subs_iMtb = '../../results/iMtb_H37Rv_1132_subsystem_accuracy.xlsx'
...
cap <- expression(bold('Figure 5. Gene Essentiality Accuracy and Percentage of Unblocked Reactions by Subsystem'))

sub_cap <- as.ggplot(sub) + labs(caption=cap) +
    theme(plot.caption=element_text(hjust=0.1, size=12))

ggsave('../../results/plots/5_iMtb_H37Rv_1132_subsystem_accuracy.png',
